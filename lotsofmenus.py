...
# Create dummy user
User1 = User(name="Srikanth Nabigari", email="srikanthnabigari108@gmail.com",
            picture='''https://lh5.googleusercontent.com/
                            -Gh8l7KH3BLE/AAAAAAAAAAI/AAAAAAAAIpg/X9MxI_EBHpc/photo.jpg''')
session.add(User1)
session.commit()
...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     description=""" A famous duck dish from Beijing[1] that has been prepared 
                                     since the imperial era. The meat is prized for its thin,
                                      crisp skin, with authentic versions of the dish
                                     serving mostly the skin and little meat, sliced in front
                                     of the diners by the cook", price="$25
                                """,
...
menuItem5 = MenuItem(user_id=1, name="Beef Noodle Soup",
                     description="""A Chinese noodle soup made of stewed or red braised beef, beef broth,
...
menuItem1 = MenuItem(user_id=1, name="Pho",
                     description="""a Vietnamese noodle soup consisting of broth,
                             linguine-shaped rice noodles called banh 
...
menuItem2 = MenuItem(user_id=1, name="Chinese Dumplings",
                     description="""a common Chinese dumpling which generally consists
                      of minced meat and finely chopped vegetables wrapped into a piece 
                      of dough skin. The skin can be either thin and elastic or thicker.
                      """,
...
menuItem4 = MenuItem(user_id=1, name="Stinky Tofu",
                     description="""Taiwanese dish, deep fried fermented tofu served
...
menuItem1 = MenuItem(user_id=1, name="Tres Leches Cake",
                     description="""Rich, luscious sponge cake soakedin sweet milk 
                      and topped with vanilla bean whipped cream and strawberries.
                      """,
...
menuItem4 = MenuItem(user_id=1, name="Cauliflower Manchurian",
                     description="""Golden fried cauliflower florets in
                      a midly spiced soya,garlic sauce cooked with fresh cilantro,
...
menuItem9 = MenuItem(user_id=1, name="Chicken Fried Steak",
                     description="""Fresh battered sirloin steak fried and
                      smothered with cream gravy", price="$8.99", course="Entree""",
                       restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Boysenberry Sorbet",
                     description="""An unsettlingly huge amount of ripe berries
                      turned into frozen (and seedless) awesomeness
                      """,
                     price="$2.99", course="Dessert", restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken",
                     ...
                     (chilli, tamarind among others) and slow cooked in a cylindrical clay or
...
menuItem2 = MenuItem(user_id=1, name="Cachapa",
                     description="""Golden brown, corn-based Venezuelan pancake;
                      usually stuffed with queso telita or queso de mano, and possibly lechon.
                      """,
                     price="$7.99", course="Entree", restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Chantrelle Toast",
                     description="""Crispy Toast with Sesame Seeds slathered with
                                 buttery chantrelle mushrooms""",
...
menuItem1 = MenuItem(user_id=1, name="Guanciale Chawanmushi",
                     description="""Japanese egg custard served hot with spicey Italian 
                     Pork Jowl (guanciale)", price="$6.95", course="Dessert""",
                      restaurant=restaurant1)
