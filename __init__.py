...
def showRestaurants():
    ...
    if 'username' not in login_session:
        ...
        user = session.query(User).filter_by(name=login_session[
                                            'username']).one()
...
def editRestaurant(restaurant_id):
    ...
    if editedRestaurant.user_id != login_session['user_id']:
        return """<script>function myFunction() {alert('You are
                not authorized to edit this restaurant. Please create
    ...
    if request.method == 'POST':
        ...
        return render_template('editRestaurant.html',
                               restaurant=editedRestaurant, user=user)
# Delete a restaurant
...
def deleteRestaurant(restaurant_id):
    ...
    if request.method == 'POST':
        ...
        user = session.query(
            User).filter_by(name=login_session['username']).one()
        return render_template('deleteRestaurant.html',
                               restaurant=restaurantToDelete, user=user)
...
def showMenu(restaurant_id):
    ...
    if 'username' not in login_session or creator.id != login_session['user_id']:  # noqa
        ...
        return render_template(
            'menu.html', items=items, restaurant=restaurant,
...
def editMenuItem(restaurant_id, menu_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return """<script>function myFunction() {alert('You are not authorized
                    to edit menu items to this restaurant. Please create
...
def deleteMenuItem(restaurant_id, menu_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return """<script>function myFunction() {alert('You are
                  ...
                  Please create your own restaurant in order to
